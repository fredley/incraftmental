var inventory = {
  ...
  objects: {
    ...
    blocks : {
      stone:          {display:'Stone'              , value: 5, symbol: 's'                                                   },
      dirt:           {display:'Dirt'               , value: 1, symbol: '%'                                                   },
      cobble:         {display:'Cobblestone'        , value: 1, symbol: 'C'                        , smelts_to: 'stone'       },
      plank:          {display:'Plank'              ,           symbol: 'P', recipe:'=' , yield:4  , fuel_source: 2           },
      sand:           {display:'Sand'               , value: 5, symbol: 'S'                        , smelts_to: 'glass'       },
      gravel:         {display:'Gravel'             , value: 5, symbol: '$'                                                   },
      gold_ore:       {display:'Gold Ore'         , value: 100, symbol: 'G'                        , smelts_to: 'gold_ingot'  },
      iron_ore:       {display:'Iron Ore'          , value: 50, symbol: 'I'                        , smelts_to: 'iron_ingot'  },
      wood:           {display:'Wood'               , value: 1, symbol: '='                        , fuel_source: 4           },
      glass:          {display:'Glass'             , value: 10, symbol: '~'                                                   },
      bed:            {display:'Bed'                ,           symbol: 'B', recipe:'WWWPPP',                                 },
      wool:           {display:'Wool'              , value: 10, symbol: 'W'                                                   },
    ...
    items: {
      ...
      coal :            {display:'Coal',           value: 10, symbol: 'c'                           , fuel_source: 8          },
      diamond :         {display:'Diamond',      value: 1000, symbol: 'd'                                                     },
      ...
      mushroom :        {display:'Mushroom',        value: 5, symbol: 'm', food: 2                                            },
      stew :            {display:'Mushroom Stew',             symbol: 'V', recipe: 'm  m  U'         , food: 12               },
      string :          {display:'String',         value: 10, symbol: '@', mob_drop:1                                         },
      gunpowder :       {display:'Gunpowder',     value: 100, symbol: 'x', mob_drop:1                                         },
      wheat :           {display:'Wheat',           value: 5, symbol: ':'                                                     },
      flour :           {display:'Flour',                     symbol: ';', recipe: ':::', cooks_to: 'bread'                   },
      bread :           {display:'Bread',                     symbol: 'b', food: 24                                           },
      flint :           {display:'Flint',                     symbol: 'Y'                                                     },
      porkchop :        {display:'Raw Porkchop',   value: 10, symbol: 'q', mob_drop:1, cooks_to: 'cooked_porkchop'            },
      cooked_porkchop : {display:'Cooked Porkchop',           symbol: 'Q', food: 20                                           },
      redstone :        {display:'Redstone',      value: 500, symbol: 'r'                                                     },
      boat :            {display:'Boat',                      symbol: '+', recipe: 'P PPPP'                                   },
      minecart :        {display:'Minecart',                  symbol: '-', recipe: 'i iiii'                                   },
      leather :         {display:'Leather',        value: 10, symbol: 'l', mob_drop:1                                         },
      milk :            {display:'Milk',            value: 5, symbol: 'M', mob_drop:1                                         },
      brick :           {display:'Brick',                     symbol: '['                                                     },
      cane :            {display:'Sugar Cane',      value: 5, symbol: '/'                                                     },
      paper :           {display:'Paper',                     symbol: '_', recipe: '///', yield:3                             },
      book :            {display:'Book',                      symbol: 'p', recipe: '___l'                                     },
      egg :             {display:'Egg',             value: 1, symbol: 'o', mob_drop:1, cooks_to: 'fried_egg'                  },
      ...
      fish :            {display:'Raw Fish',       value: 10, symbol: 'z', cooks_to: 'cooked_fish'                            },
      cooked_fish :     {display:'Cooked Fish',               symbol: 'Z', food: 20                                           },
      sugar :           {display:'Sugar',                     symbol: ',', recipe: '/', food:2                                },
      bonemeal :        {display:'Bonemeal',       value: 50, symbol: '#', mob_drop: 1                                        },
    },
