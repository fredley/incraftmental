var inventory = {
  ...
  objects: {
    ...
    items: {
      ...
      bread :           {display:'Bread',           symbol: 'b', recipe: ';;;', yield:3   , food: 30                },
      flint :           {display:'Flint',           symbol: 'Y'                                                     },
      porkchop :        {display:'Raw Porkchop',    symbol: 'q', mob_drop:1, smelts_to: 'cooked_porkchop'           },
      cooked_porkchop : {display:'Cooked Porkchop', symbol: 'Q', cooked_from: 'porkchop'  , food: 20                },
      ...
      egg :             {display:'Egg',             symbol: 'o', food: 2, mob_drop:1                                },
      ...
      cooked_fish :     {display:'Cooked Fish',     symbol: 'Z', food: 20, cooked_from: 'fish'                      },
    ...
    tools : {
      ...
      stone_hoe :       {display:'Stone Hoe',       profession: 'chef',       recipe: 'CC  |  |', bonus:2, gives: {seeds: 0.2}                                                                      },
      iron_hoe :        {display:'Iron Hoe',        profession: 'chef',       recipe: 'ii  |  |', bonus:3, gives: {seeds: 0.2, mushroom:0.1}                                                        },
